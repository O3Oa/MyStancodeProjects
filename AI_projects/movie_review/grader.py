...
-----------------------------
Milestone 4 answer:
    when numEpochs:40/70/80/90
    train error:0.036015/0.0146314/0.012380/0.0095666
    validation error:0.267304/0.2613956/0.263038/0.265897
    train error continue to decrease
    validation error is uncertain
    the model may be over fitting training data
"""
...
def test3c0():
    ...
    d2 = graderUtil.read_dictionary()
    grader.require_is_equal(ans, util.dotProduct(d1,  d2))
grader.add_basic_part('3c-0', test3c0, max_points=10, max_seconds=3, description="basic sanity check for the answer of dot product of 2 sparse vectors d1 and d2")
...
# TODO: extractCharacterFeatures need much more execution time and get bad accuracy
# TODO: nums of CharacterFeatures is too large, and lot of them are nonsense,
#        so if the model over fitting the nonsense train data, will be a bad model.
############################################################
